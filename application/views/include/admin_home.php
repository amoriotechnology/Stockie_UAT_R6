...
<div style="<?php if($sale_setting=='disable'){ echo "display: none;"; }else{ echo "display: block;"; } ?>" >
                    <div class="card-single col">
                        ...
                        <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #18628f;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Sale</a>
	</div></div>
                    </div>
                    ...
                    <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #9D467A;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Expenses</a>
	</div>
                    </div>
                    </div>
                    ...
                    <div class="card-single col">
                        ...
                        <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #489D86;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Sales Invoice</a>
	</div></div>
                    </div>
                    ...
                    <div class="card-single col">
                        ...
                        <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #B68448;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Expense Invoice</a>
	</div></div>
                    </div>
                </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="cards">
                    ...
                    <div class="card-single col">
                        ...
                        <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #9B59B6 ;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Product Sold</a>
	</div></div>
                    </div>
                    ...
                    <div class="card-single col">
                        ...
                        <div>
                            <h1 id="customer"></h1>
                            <span style="background-color: #76448A;float:left;padding:10px;border-radius:10px;"> <i class="fa fa-users" style="color: #fff;"></i></span>
                        </div>
                        <div>
		...
		<a href="<?php echo base_url('Ccustomer/manage_customer') ?>">Total Product Purchased</a>
	</div></div>
                    </div>
                </div>
    </div>
                ...
                <div class="col-sm-12 col-md-12" style="<?php if($todays_sales_reportsetting=='disable'){ echo "display: none;"; }else{ echo "display: block;"; } ?>">
                    <div class="panel panel-bd">
                        ...
                        <div class="panel-body">
                            ...
                            <?php  if(is_array($todays_sales_report) && count($todays_sales_report)>0)
                                     {  ?>
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        $todays = date('Y-m-d');
                                        if(is_array($todays_sales_report) && count($todays_sales_report)>0)
                                     {
                                            $sl = 0;
...
$(document).ready(function(){
    var  prev_month =new Date().getFullYear();
   prev_month=prev_month+'-'+'01-01';
   // $prev_month =" <?php echo date('Y-m-d', strtotime('-1 months', strtotime('NOW'))) ?>"; 
var current=new Date().getFullYear()+'-'+("0"+(new Date().getMonth()+1)).slice(-2)+'-'+("0"+new Date().getDate()).slice(-2);
 var date= prev_month+" to "+ current;
    $("#daterangepicker-field").attr("value", date);
